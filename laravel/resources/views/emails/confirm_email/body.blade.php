    ...
    <body class="email-template">
        <div style="padding:8px; box-sizing:border-box;font-family:sans-serif;">
            ...
            <div style="margin-top:10px;">
                <a  href="{{ URL::to('register/verify/' . $confirmation_code) }}" style="display:inline;width:170px;height:40px; line-height:40px; text-align:center; background:#3e8ff8; color: #fff; padding:9px 25px; text-decoration:none; box-shadow:inset 0px 0px 3px #fefefe;">Verify Your Account</a>
            </div>

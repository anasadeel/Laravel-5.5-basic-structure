            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a class="btn btn-primary btn-flat" href="{{url('admin/content/create')}}?type=<?php echo $type; ?>">Add new <?php echo $type; ?> template</a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <ul class="products-list product-list-in-box">
                        <table class="table" id="order_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><a href="{{ url($row->code) }}" target="_blank"><?php echo $row->title; ?></a></td>

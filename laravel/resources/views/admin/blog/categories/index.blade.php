            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
			    ...
			    <li class="item">
                    ...
                    <br />
                    <a href="<?php echo url('admin/blog/categories/delete/'. $row->id); ?>">Delete</a>
                 
                  </div>
                
                  <div class="product-info">
                    <a href="<?php echo url('admin/blog/categories/edit/'. $row->id); ?>" class="product-title"><?php  echo $row->name; ?>
